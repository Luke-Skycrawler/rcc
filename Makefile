...
CC = g++
all: main.cpp rcc.tab.cpp lex.yy.c rccGlobal.hpp codegen.h codegen.cpp AST.hpp llvmGlobal.cpp ast.cpp
	${CC} ${LLVMFLAGS} main.cpp rcc.tab.cpp lex.yy.c codegen.cpp llvmGlobal.cpp ast.cpp -o rcc -lm
	./rcc test/easy.c
rcc.tab.cpp: rcc.ypp 
	bison -d rcc.ypp
lex.yy.c: rcc.l
